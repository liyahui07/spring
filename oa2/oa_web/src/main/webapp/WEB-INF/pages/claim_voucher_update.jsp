        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <form:form id="admin-form" name="addForm" action="/claim_voucher/update" modelAttribute="info">
                    ...
                    <c:forEach items="${info.items}" var="sta">
                            <div>
                                <div class="col-md-3">
                                    <label for="items[${sta.index}].item" class="field prepend-icon">
                                        ...
                                        <form:select path="items[${sta.index}].item" cssClass="gui-input" placeholder="花销类型..." items="${item}"></form:select>
                                    </label>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-5">
                                    <label for="items[${sta.index}].comment" class="field prepend-icon">
                                        <from:input path="items[${sta.index}].comment" cssClass="gui-input" placeholder="备注..." />
