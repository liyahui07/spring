    ...
    <div class="tray tray-center">
        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <form:form id="admin-form" name="addForm" action="/claim_voucher/add" modelAttribute="claimVoucherInfo">
                            ...
                            <div>
                                <div class="col-md-3">
                                    <label for="items[0].item" class="field prepend-icon">
                                        <form:select path="items[0].item" cssClass="gui-input" placeholder="花销类型..." items="${item}"></form:select>
                                    </label>
                                </div>
                                <div class="col-md-3">
